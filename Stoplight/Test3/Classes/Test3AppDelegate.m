...
@synthesize window;
@synthesize glView;
@synthesize lblPoints, lblSliderValue, lblDebug, lblAuto, lblFast, lblSlow, lblRed, lblYellow, lblGreen;
@synthesize sliderScale, sliderRed, sliderYellow, sliderGreen;
